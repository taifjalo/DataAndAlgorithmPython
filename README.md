...
> Factorial is used to calculate the number of [permutations](https://en.wikipedia.org/wiki/Permutation) of a set of objects. For example, the factorial of 5 (written as 5!) is 5 _ 4 _ 3 _ 2 _ 1 = 120. This means that you are able to arrange 5 items in 120 different ways.
